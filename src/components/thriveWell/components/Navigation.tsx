      ...
      <div className="flex flex-wrap items-end self-start w-full font-bold max-w-[1364px] text-sky-950 max-md:max-w-full">
        <div className="flex flex-wrap grow shrink justify-center items-center min-w-[240px] w-[897px] max-md:max-w-full">
          ...
          <nav className="flex gap-6 items-center self-stretch my-auto text-base min-w-[240px]">
            <a href="#home" className="flex flex-col justify-center items-start self-stretch py-2 pl-2.5 my-auto whitespace-nowrap min-h-[36px] w-[58px]">
              <div className="pb-2 w-12">Home</div>
            </a>
            <a href="#about" className="flex flex-col justify-center self-stretch p-2.5 my-auto w-[86px]">
              <div className="py-0.5 w-full max-md:pr-0">About Us</div>
            </a>
            <a href="#services" className="flex flex-col justify-center self-stretch p-2.5 my-auto whitespace-nowrap w-[86px]">
              <div className="py-0.5 w-full">Services</div>
            </a>
            <a href="#contact" className="flex flex-col justify-center self-stretch p-2.5 my-auto whitespace-nowrap w-[86px]">
